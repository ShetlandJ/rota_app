...
<template>
    <header
        class="border-b lg:flex md:items-center md:justify-between p-4 pb-0 shadow-lg md:pb-4 bg-gray-100 dark:bg-gray-800"
    >
        <div class="flex items-center justify-between w-full mb-4 md:mb-0">
            ...
            /> -->
            <Link
                class="border-t block no-underline hover:underline py-2 text-grey-darkest hover:text-black md:border-none md:p-0 dark:text-white dark:hover:text-white"
                :href="route('register')"
            >
                Register
            </Link>
            ...
            >
                ...
                <!-- <JetDropdown align="right" width="48">
                    ...
                    <template #content>
                        ...
                        <JetNavLink
                            class="cursor-pointer m-2 mb-2"
                            :active="route().current('recipe.categories')"
                        >
                            Recipe Categories
                        </JetNavLink>
                    </template>
                ...
                <!-- <li class="md:ml-4 my-2">
                    <Link
                        class="
                            ...
                            dark:text-white dark:hover:text-white
                        "
                        :class="{ 'font-bold': $page.url === '/ingredients' }"
                    >
                        Ingredients
                    </Link>
                </li>
                <li class="md:ml-4 my-2">
                    <Link
                        class="
                            ...
                            dark:text-white dark:hover:text-white
                        "
                        :class="{ 'font-bold': $page.url === '/recipes' }"
                    >
                        Recipes
                    </Link>
                </li> -->
